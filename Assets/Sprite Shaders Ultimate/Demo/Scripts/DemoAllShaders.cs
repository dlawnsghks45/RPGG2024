    ...
    public class DemoAllShaders : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            for (int n = 0; n < shadersParent.childCount; n++)
            {
                ...
                newCategory.GetComponent<DemoShaderButton>().Invoke(nameof(DemoShaderButton.StartFadeIn), 0.02f);
        ...
        public void SelectShader(string category, string shader)
        {
            ...
            if (category != "" && currentCategory != category)
            {
                ...
                for (int n = 0; n < shadersUI.childCount; n++)
                {
                    ...
                    {
                        child.GetComponent<DemoShaderButton>().Invoke(nameof(DemoShaderButton.FadeAway), delay);
                        delay += delayIncrease;
                    }
                }
                ...
                for (int n = 0; n < shaderCategory.childCount; n++)
                {
                    ...
                    newShader.GetComponent<DemoShaderButton>().Invoke(nameof(DemoShaderButton.StartFadeIn), delay);
                    delay += delayIncrease;
                }
            }
