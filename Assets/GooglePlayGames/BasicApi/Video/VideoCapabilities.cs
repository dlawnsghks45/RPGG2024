...
namespace GooglePlayGames.BasicApi.Video
{
    ...
    public class VideoCapabilities
    {
        ...
        {
            return
                $"[VideoCapabilities: mIsCameraSupported={mIsCameraSupported}, mIsMicSupported={mIsMicSupported}, mIsWriteStorageSupported={mIsWriteStorageSupported}, " +
                $"mCaptureModesSupported={string.Join(",", mCaptureModesSupported.Select(p => p.ToString()).ToArray())}, mQualityLevelsSupported={string.Join(",", mQualityLevelsSupported.Select(p => p.ToString()).ToArray())}]";
        }
    }
}