...
namespace GooglePlayGames.BasicApi.Video
{
    ...
    public class VideoCaptureState
    {
        ...
        {
            return
                $"[VideoCaptureState: mIsCapturing={mIsCapturing}, mCaptureMode={mCaptureMode.ToString()}, mQualityLevel={mQualityLevel.ToString()}, " +
                $"mIsOverlayVisible={mIsOverlayVisible}, mIsPaused={mIsPaused}]";
        }
    }
}