...
namespace GooglePlayGames.BasicApi
{
    ...
    public class Achievement
    {
        ...
        {
            return
                $"[Achievement] id={mId}, name={mName}, desc={mDescription}, type={(mIsIncremental ? "INCREMENTAL" : "STANDARD")}, revealed={mIsRevealed}, unlocked={mIsUnlocked}, steps={mCurrentSteps}/{mTotalSteps}";
        }
